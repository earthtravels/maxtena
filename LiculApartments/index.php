                            ...
                            <div class="inner">
                                <div class="box box_3-1  gray">
                                    ...
                                    <div class="icon clear">                                        
                                        ...
                                        <div id="book">
                                            <form id="contact_form" action="booking-search.php" method="post">
                                            <div class="clear">
                                                <label for="name">
                                            ...
                                            <div class="clear">
                                                ...
                                                <select name="adults" id="adults" class="select">
                                          		<?php
                                          			$max_capacity = 0;
													$sql_max_capacity=mysql_query("select MAX(capacity) as capacity from bsi_capacity");
													if($row=mysql_fetch_assoc($sql_max_capacity))
													{
