      ...
      <table width="100%" border="0"  cellspacing="0" cellpadding="0" bgcolor="<?=$light?>" style="border:solid 1px <?=$light?>">
        <tr bgcolor="<?=$light?>" >
          <td height="25">&nbsp;&nbsp;<font color="#FFFFFF" face="Arial, Helvetica, sans-serif"><b>Website Menu &amp; Content Manager</b></font> &nbsp;&nbsp;&nbsp;
           <img src="images/add_menu.png" border="0" onclick="javascript:window.location.href='page.editor.php?id=0'" align="absmiddle" style="cursor:pointer; cursor:hand;"/></td>
...
while($d=@mysql_fetch_array($r)):
	...
	if(in_array($d[id],$tids)):
	    ...
	    if($n):  
	        echo"<a href='" . $_SERVER[PHP_SELF] . "?tid=". $tid . "|" . $d[id] . "|'\"><img src='images/001_01.png' border=0 align='absmiddle' ></a>&nbsp;"; 
        else:
    ...
    echo"<a  href='page.editor.php?tid=" . $_REQUEST[tid] . "&id=" . $d[id] . "' class='bodytext'>" . $d['cont_title_'.$row_default_lang['lang_code']] . "</a></td>
	<td></td><td></td><td class='bodytext'>".$d['ord']."</td><td class='bodytext'>".$stat1."</td><td><a class='bodytext' href='page.editor.php?tid=" . $_REQUEST[tid] . "&id=" . $d[id] . "'><img src='images/button_edit.gif' border='0'/></a>&nbsp;<a class='bodytext' href='content.list.php?tid=" . $_REQUEST[tid] . "&del=" . $d[id] . "'><img src='images/button_delete1.gif' border='0'/></a> </td></tr>";
    if(in_array($d[id],$tids)):
		...
		while($dd=mysql_fetch_array($rr)):
	        ...
	        echo"<tr bgcolor=whitesmoke><td>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;|______________________________</td><td><a  class='bodytext' href='page.editor.php?tid=" . $_REQUEST[tid] . "&id=" . $dd[id] . "'>" . $dd['cont_title_'.$row_default_lang['lang_code']] . "</a></td><td></td><td class='bodytext'>".$dd['ord']."</td><td class='bodytext'>".$stat2."</td><td> <a class='bodytext' href='page.editor.php?tid=" . $_REQUEST[tid] . "&id=" . $dd[id] .  "'><img src='images/button_edit.gif' border='0'/></a>&nbsp;<a class='bodytext' href='content.list.php?tid=" . $_REQUEST[tid] . "&del=" . $dd[id] . "'><img src='images/button_delete1.gif' border='0'/></a> </td></tr>";
			...
			if($d3['status']=='Y'){$stat3="Active";}else{$stat3="Hidden";}
			    echo"<tr bgcolor=whitesmoke><td></td><td>|_____________________<td><a href='page.editor.php?tid=" . $_REQUEST[tid] . "&id=" . $d3[id] . "&parent_id=" . $dd[id] . "' class='bodytext'>" . $d3['cont_title_'.$row_default_lang['lang_code']] . "</td><td class='bodytext'>".$d3['ord']."</td><td class='bodytext'>".$stat3."</td><td> <a href='page.editor.php?tid=" . $_REQUEST[tid] . "&id=" . $d3[id] . "' class='bodytext'><img src='images/button_edit.gif' border='0'/></a>&nbsp;<a class='bodytext' href='content.list.php?tid=" . $_REQUEST[tid] . "&del=" . $d3[id] . "'><img src='images/button_delete1.gif' border='0'/></a> </td></tr>";
		    endwhile;		
		    $k++;
        endwhile;
	endif;	
