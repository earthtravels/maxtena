...
<table align="center" width="950" border="0" cellspacing="0" cellpadding="0">
  ...
  <tr>
    ...
    <td align="right" valign="bottom" class="bodyMenutext8pt"><a href="../index.php" target="_blank" class="bodyMenutext8pt">Visit Site</a> | <a href="logout.php" class="bodyMenutext8pt">Log Out</a></td>
  </tr>
  <tr>
    <td height="10"></td>
    <td></td>
...
<table align="center" width="950" border="0" cellspacing="0" cellpadding="0">
  ...
  <tr>
    <td align="left">
	  <table border="0" style="background-image:url(images/menu_tile.gif);" cellspacing="0" cellpadding="0">
		  <tr>
...
?>
			...
			<td><img src="images/menubar_right.gif" alt="" width="13" height="40" /></td>
		  </tr>
		</table>